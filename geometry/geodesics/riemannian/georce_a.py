...
class GEORCE_A(ABC):
    ...
    def SGinv(self,
        ...
        return jnp.linalg.pinv(self.SG(z, batch))
    ...
    def inner_product(self,
        ...
        Gt = vmap(self.SG, in_axes=(0,None))(zt, batch)
    ...
    def sample_estimates(self,
        ...
        SG0 = self.SG(self.z0, batch)
        SG = vmap(self.SG, in_axes=(0,None))(zt, batch)
    ...
    def unconstrained_opt(self, gt:Array, gt_inv:Array)->Array:
        ...
        muT = -jnp.linalg.lstsq(ginv_sum, rhs)[0]
    ...
    def while_step(self,
        ...
        SGinv_hat = jnp.vstack((jnp.linalg.pinv(SG0_hat).reshape(1,self.M.dim,self.M.dim), 
                                vmap(lambda g: jnp.linalg.pinv(g))(SG_hat)))
    ...
    def __call__(self, 
        ...
        SGinv = jnp.vstack((jnp.linalg.pinv(SG0).reshape(1,self.M.dim,self.M.dim), 
                            vmap(lambda g: jnp.linalg.pinv(g))(SG)))
